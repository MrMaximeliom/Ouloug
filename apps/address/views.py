...
"""
class AddressGroupPermission(PermissionRequiredMixin):
...
access.
"""
class CountryListView(AddressGroupPermission, ListView):
...
"""
class CountryFormView(AddressGroupPermission, FormView):
    ...
    class CityListView(AddressGroupPermission, ListView):
        # specify the model used in the view
        model = City
        # specify the template in the view
...
it allows only ouloug_admin users to access it
"""
class CityFormView(AddressGroupPermission, FormView):
    # specify template name used to add new countries
...
it allows only ouloug_admin users to access it
"""
class StateFormView(AddressGroupPermission, FormView):
    # specify template name used to add new countries
...
access.
"""
class StateListView(AddressGroupPermission, ListView):
    # specify the model used in the view
    model = State
    # specify the template in the view
...
class CurrencyFormView(AddressGroupPermission, FormView):
...
class CurrencyListView(AddressGroupPermission, ListView):
    # specify the model used in the view
    model = Currency
    # specify the template in the view
...
class BusinessFormView(AddressGroupPermission, FormView):
    # specify template name used to add new currencies
    template_name = 'address/Business_Type/add_business_type.html'
    # specify the form used
    form_class = CurrencyForm
    # specify the page to return to after successfully adding new currency
...
class BusinessListView(AddressGroupPermission, ListView):
    # specify the model used in the view
    model = Business_Type
    # specify the template in the view
    template_name = "address/business/business_list.html"
    # adding active flag for the sidebar active link
...
class TeamsFormView(AddressGroupPermission, FormView):
    # specify template name used to add new currencies
    template_name = 'address/teams/add_teams.html'
    # specify the form used
...
class TeamListView(AddressGroupPermission, ListView):
    # specify the model used in the view
    model = Team
    # specify the template in the view
    template_name = "address/teams/teams_list.html"
    # adding active flag for the sidebar active link
