...
from Util.static_strings import (NO_RECORDS_FOR_COUNTRY_MODEL_MONITOR_MESSAGE,
    NO_RECORDS_FOR_COUNTRY_MODEL_ADMIN_MESSAGE,NO_RECORDS_FOR_CITY_MODEL_ADMIN_MESSAGE,NO_RECORDS_FOR_CITY_MODEL_MONITOR_MESSAGE)
...
class CityFormView(AddressGroupPermission, FormView):
    # specify template name used to add new countries
    template_name = 'cities/add_cities.html'
    # specify the form used
    form_class = CityForm
    # specify the page to return to after successfully adding new country
    success_url = 'cities'
